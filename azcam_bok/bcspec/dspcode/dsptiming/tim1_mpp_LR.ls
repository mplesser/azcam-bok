Motorola DSP56000 Assembler  Version 6.3.0   117-07-02  09:26:42  tim1.asm  Page 1
...
Motorola DSP56000 Assembler  Version 6.3.0   117-07-02  09:26:42  tim1.asm  Page 2
...
117    
Motorola DSP56000 Assembler  Version 6.3.0   117-07-02  09:26:42  tim1.asm  Page 3
...
174       P:0135 P:0135 44F400            MOVE              #'RDA',X0
                        524441
Motorola DSP56000 Assembler  Version 6.3.0   117-07-02  09:26:42  tim1.asm  Page 4
...
236    
Motorola DSP56000 Assembler  Version 6.3.0   117-07-02  09:26:42  tim1.asm  Page 5
...
Motorola DSP56000 Assembler  Version 6.3.0   117-07-02  09:26:42  tim1.asm  Page 6
...
Motorola DSP56000 Assembler  Version 6.3.0   117-07-02  09:26:42  tim1.asm  Page 7
...
410    
411                             ; *******************************************************************
Motorola DSP56000 Assembler  Version 6.3.0   117-07-02  09:26:42  tim1.asm  Page 8
...
Motorola DSP56000 Assembler  Version 6.3.0   117-07-02  09:26:42  tim1.asm  Page 9
...
505       1.000000E+000         PMPP_HI   EQU     +1.0                              ; 1 phase
...
533                                       IF      1
534       1.000000E+000         P3_HI     EQU     PMPP_HI
535       -6.500000E+000        P3_LO     EQU     PMPP_LO
536                                       ELSE
Motorola DSP56000 Assembler  Version 6.3.0   117-07-02  09:26:42  waveforms.asm  Page 10
...
544                                       IF      1
545       1.000000E+000         Q3_HI     EQU     PMPP_HI
546       -6.500000E+000        Q3_LO     EQU     PMPP_LO
547                                       ELSE
550                                       ENDIF
551    
...
Motorola DSP56000 Assembler  Version 6.3.0   117-07-02  09:26:42  tim1.asm  Page 11
...
Motorola DSP56000 Assembler  Version 6.3.0   117-07-02  09:26:42  tim1.asm  Page 12



665       000773                P3H       EQU     P3+255-@CVI((P3_HI+10.0)/20.0*255)
666       0007D3                P3L       EQU     P3+255-@CVI((P3_LO+10.0)/20.0*255)
...
673       000B73                Q3H       EQU     Q3+255-@CVI((Q3_HI+10.0)/20.0*255)
674       000BD3                Q3L       EQU     Q3+255-@CVI((Q3_LO+10.0)/20.0*255)
675    
...
726    
Motorola DSP56000 Assembler  Version 6.3.0   117-07-02  09:26:42  tim1.asm  Page 13
...
736                                       IF      1
737                                       INCLUDE "p_12_321t_mpp.asm"
738                             ; p_12_321t_mpp.asm
739       Y:004B Y:004B                   DC      PCLK+TGH                          ; TGH
740       Y:004C Y:004C                   DC      PCLK+P1H                          ; 1
741       Y:004D Y:004D                   DC      PCLK+P3H                          ; 1+3
742       Y:004E Y:004E                   DC      PCLK+P1L                          ; 3
743       Y:004F Y:004F                   DC      PCLK+P2H                          ; 3+2
744       Y:0050 Y:0050                   DC      PCLK+P3L                          ; 2
745       Y:0051 Y:0051                   DC      PCLK+P1H                          ; 2+1
746       Y:0052 Y:0052                   DC      PCLK+P2L                          ; 1
747       Y:0053 Y:0053                   DC      PCLK+P1L                          ; 1
748       Y:0054 Y:0054                   DC      PCLK+TGL                          ; TGL
749                                       ELSE
751                                       ENDIF
752                             EPXFER
753                                       INCLUDE "s_2_321w.asm"
754                             ; s_2_321w.asm generic SW
755    
756       Y:0055 Y:0055         FSXFER    DC      EFSXFER-FSXFER-2
757       Y:0056 Y:0056                   DC      SCLK+RGH                          ; reset
758       Y:0057 Y:0057                   DC      SCLK+RGL
759       Y:0058 Y:0058                   DC      SCLK+SWH
760       Y:0059 Y:0059                   DC      SCLK+S1H                          ; 2+1
761       Y:005A Y:005A                   DC      SCLK+S2L                          ; 1
762       Y:005B Y:005B                   DC      SCLK+S3H                          ; 1+3
763       Y:005C Y:005C                   DC      SCLK+S1L                          ; 3
764       Y:005D Y:005D                   DC      SCLK+S2H                          ; 3+2
765       Y:005E Y:005E                   DC      SCLK+S3L                          ; 2
766       Y:005F Y:005F                   DC      SCLK+SWL
767                             EFSXFER
768    
769       Y:0060 Y:0060         SXFER0    DC      ESXFER0-SXFER0-2
770       Y:0061 Y:0061                   DC      VP+%00011101
771       Y:0062 Y:0062                   DC      SCLK+RGH                          ; reset
772       Y:0063 Y:0063                   DC      SCLK+RGL
773       Y:0064 Y:0064                   DC      SCLK+SWH
774       Y:0065 Y:0065                   DC      SCLK+S1H                          ; 2+1
775       Y:0066 Y:0066                   DC      SCLK+S2L                          ; 1
776       Y:0067 Y:0067                   DC      SCLK+S3H                          ; 1+3
777       Y:0068 Y:0068                   DC      SCLK+S1L                          ; 3
778       Y:0069 Y:0069                   DC      SCLK+S2H                          ; 3+2
779       Y:006A Y:006A                   DC      SCLK+S3L                          ; 2
780                             ESXFER0
781    
782       Y:006B Y:006B         SXFER1    DC      ESXFER1-SXFER1-2
783       Y:006C Y:006C                   DC      SCLK+S1H                          ; 2+1
784       Y:006D Y:006D                   DC      SCLK+S2L                          ; 1
785       Y:006E Y:006E                   DC      SCLK+S3H                          ; 1+3
786       Y:006F Y:006F                   DC      SCLK+S1L                          ; 3
787       Y:0070 Y:0070                   DC      SCLK+S2H                          ; 3+2
788       Y:0071 Y:0071                   DC      SCLK+S3L                          ; 2
789                             ESXFER1
Motorola DSP56000 Assembler  Version 6.3.0   117-07-02  09:26:42  s_2_321w.asm  Page 14



790    
791       Y:0072 Y:0072         SXFER2    DC      ESXFER2-SXFER2-2
792                                       INTNOISE
801       Y:007A Y:007A                   DC      SCLK+SWL
802                                       INTSIGNAL
809                             ESXFER2
810                                       ENDIF
811    
...
843                                       ENDIF
844    
845                             ; *** reverse par shifting not used ***
846       00004A                RXFER     EQU     PXFER
847       00004A                PQXFER    EQU     PXFER
848    
849                             ; Check for overflow in the EEPROM case
850                                       IF      !1
854                                       ENDIF
855    
856                                ENDSEC                                    ; end of TIMAZCAM section
857    
858                                END                                       ; end of program
